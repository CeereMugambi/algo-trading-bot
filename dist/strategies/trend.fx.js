...
export function fxTrend(candles) {
    ...
    // Session filter
    if (!isFxTradable(lastCandle.time))
        return { signal: "NONE" };
...
//# sourceMappingURL=trend.fx.js.map